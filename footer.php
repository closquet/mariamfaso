        ...
        <div class="footer__main-part bloc">
            <div class="wrap footer__main-part__container">
                <section aria-labelledby="footer__item__title1" class="footer__item">
                    ...
                    <p class="address">
                        <span class="address__part">Mariam Faso ASBL</span>
                        <span class="address__part">Rue de la gare, 15</span>
                        <span class="address__part">6600 Bastogne</span>
                    </p>
                    <p>
                        <a class="link" href="mailto: info@mariam-faso.be">info@mariam-faso.be</a>
                    </p>
                    <p>
                        <a class="link" href="tel: +32479215744">+32 (0) 479 21 57 44</a>
                    </p>
                </section>
                ...
                <section aria-labelledby="footer__item__title4" class="footer__item">
                    ...
                    <a class="partner-logo" title="Aller sur notre page Facebook" href="https://www.facebook.com/MariamFaso/"><img width="50" height="50" src="<?php ec_asset( 'images/logo/fb.svg' ); ?>" alt="Logo Facebook"></a>
                </section>
            </div>
        </div>
